...
class BLOBHolder:
    ...
    def write(self, dst, name):
      ...
      writer = self._declare if self.all_zeros else self._write_with_values
      writer(dst, name)
